...
func (suite *EventDispatcherTestSuite) SetupTest() {
	...
	suite.handler = TestEventHandler{ID: "handler1"}
	suite.handler2 = TestEventHandler{ID: "handler2"}
	suite.handler3 = TestEventHandler{ID: "handler3"}
...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Remove() {
	...
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
	suite.Equal(suite.T(), &suite.handler2, suite.eventDispatcher.handlers[suite.event.GetName()][0])
...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Dispatch_Async() {
	eh := &MockHandler{}
